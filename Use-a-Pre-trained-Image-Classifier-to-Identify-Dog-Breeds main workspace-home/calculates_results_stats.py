...
def calculates_results_stats(results_dic):
    ...
    for key, value in results_dic.items():
        ...
        # Count number of matches between pet and classifier labels
        if value[2] == 1:
            n_match += 1
        ...
        # Count number of correct breed classifications
        if value[3] == 1 and value[4] == 1 and value[2] == 1:
            n_correct_breed += 1
    ...
    # Add the statistics to the results_stats_dic
